    ...
    form.addEventListener('submit', (event: Event) => {
        ...
        const resumeHTML = `
            <div>
                ...
                <p style="margin-top:10px; font-size:1rem;">${field}</p>
                <h2 style="margin-top:10px; width:100%; background-color:#d6d297; color:black;">Contact Information</h2>
                <p style="margin-top:9px; font-size:1rem;"><b>Phone:</b> ${phone}</p>
                <p style="margin-top:9px; font-size:1rem;"><b>Email:</b> ${email}</p>
                <p style="margin-top:9px; font-size:1rem;"><b>Address:</b> ${address}</p>
                <h2 style="margin-top:10px; width:100%; background-color:#d6d297; color:black;">Personal Skills</h2>
                <p style="margin-top:9px; font-size:1rem;">${personalSkillsInput}</p>
                <h3 style="margin-top:10px; width:100%; background-color:#d6d297; color:black;">Languages</h3>
                <p style="margin-top:9px; display:flex; flex-direction:column; font-size:1rem;">${selectedLanguages.join(", ")}</p>
                <h3 style="margin-top:10px; width:100%; background-color:#d6d297; color:black;">Career Objective</h3>
                <p style="margin-top:9px; font-size:1rem;">${career}</p>
                <h3 style="margin-top:10px; width:100%; background-color:#d6d297; color:black;">Education</h3>
                <p style="margin-top:9px; font-size:1rem;">${education} (${from} to ${to})</p>
                <h3 style="margin-top:10px; width:100%; background-color:#d6d297; color:black;">Technical Skills</h3>
                <p style="margin-top:5px; font-size:1rem;">${technicalSkills}</p>
            </div>
        `;
